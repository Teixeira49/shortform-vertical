...
import 'package:venetiktok/src/shared/core/utils/asset_icons.dart';
...
part '../widgets/premium_body.dart';
part '../widgets/premium_widgets.dart';
...
class PremiumPaywallPage extends StatelessWidget {
  ...
  /// with named routes.
  static const routeName = 'get-premium';

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PremiumPageBloc(),
      child: Scaffold(
        appBar: AppBar(
          title: Text(context.l10n.premiumTitleLabel),
...
/// {@endtemplate}
///
class _PremiumPaywallView extends StatelessWidget {
  /// {@macro success_view}
  const _PremiumPaywallView();

  @override
  Widget build(BuildContext context) {
    return const _PremiumPaywallBody();
  }
}
