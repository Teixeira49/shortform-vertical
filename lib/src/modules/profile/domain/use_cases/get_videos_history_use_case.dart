...
class GetVideosHistoryUseCase {
  ...
  // Constructor
  const GetVideosHistoryUseCase({required IProfileRepository profileRepository})
  ...
  Future<List<Video>> execute({required FeedVideoParams params}) async {
    try {
      return await _profileRepository.getVideoHistory(params: params);
    } catch (e) {
      rethrow;
    }
  }
